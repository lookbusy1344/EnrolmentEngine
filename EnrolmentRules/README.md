...
- an intranet or website similar to [Green Shoots demo site](https://enrolment-web-zeb6shxnca-ew.a.run.app)
...
stateless, designed for integration, and licensed under AGPLv3.
...
explains the decision process from first principles. For a layer-by-layer breakdown of the app — what each layer does and which files belong to it —
see
