namespace EnrolmentRules.Web.Infrastructure;
...
internal readonly struct EquatableDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, TValue>, IEquatable<EquatableDictionary<TKey, TValue>>
	where TKey : notnull
{
...
internal static class EquatableDictionaryFactory
{
	/// <summary>
