...
///     Scans the tracked <c>.cs</c> and <c>.cshtml</c> sources under <c>src</c> and <c>tests</c>.
/// </summary>
public sealed class PostfixIncrementArchitectureTests
{
	...
	[Theory]
	[InlineData("<div class=\"card card--narrow\"></div>")]
...
internal static partial class PostfixIncrementGuard
{
	...
	// that tightly keeps both markup (`card--narrow`, `-- none --`, CSS `--bs-*` custom properties) and
