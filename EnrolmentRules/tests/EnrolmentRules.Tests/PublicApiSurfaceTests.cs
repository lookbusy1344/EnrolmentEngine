		...
		var assemblies = new[] {
			(typeof(StudentInput).Assembly,
				new[] {
					...
					"EnrolmentRules.Domain.GcseResult", "EnrolmentRules.Domain.GcseScoreboard", "EnrolmentRules.Domain.GcseSubjects", "EnrolmentRules.Domain.GradeChange", "EnrolmentRules.Domain.LargeStructAttribute", "EnrolmentRules.Domain.LintFinding", "EnrolmentRules.Domain.LintSeverity", "EnrolmentRules.Domain.PredictedGrade", "EnrolmentRules.Domain.PolicyFacts",
