		...
		var assemblies = new[] {
			(typeof(StudentInput).Assembly,
				new[] {
					...
					"EnrolmentRules.Domain.EnumNames", "EnrolmentRules.Domain.EntryEquivalent", "EnrolmentRules.Domain.ExclusionPair",
					"EnrolmentRules.Domain.ExplainedResult", "EnrolmentRules.Domain.Explanation", "EnrolmentRules.Domain.EquatableArray",
					"EnrolmentRules.Domain.EquatableArray`1", "EnrolmentRules.Domain.EquatableDictionary`2",
					"EnrolmentRules.Domain.EquatableDictionaryFactory", "EnrolmentRules.Domain.GateAdvice", "EnrolmentRules.Domain.GcseResult",
					"EnrolmentRules.Domain.GcseSubjects", "EnrolmentRules.Domain.GradeChange", "EnrolmentRules.Domain.LintFinding",
					"EnrolmentRules.Domain.LintSeverity", "EnrolmentRules.Domain.PredictedGrade", "EnrolmentRules.Domain.PolicyFacts",
					"EnrolmentRules.Domain.PolicyThresholds", "EnrolmentRules.Domain.PolicyThresholdsException",
					"EnrolmentRules.Domain.PolicyThresholdsStore", "EnrolmentRules.Domain.PredictionModel",
					"EnrolmentRules.Domain.PredictionModel+Coefficients", "EnrolmentRules.Domain.Prerequisite",
					"EnrolmentRules.Domain.PrerequisiteSatisfaction", "EnrolmentRules.Domain.Qualification",
					...
					"EnrolmentRules.Domain.SubjectJsonConverter", "EnrolmentRules.Domain.SubjectMeta", "EnrolmentRules.Domain.Thresholds",
					"EnrolmentRules.Domain.TransitionEvidence", "EnrolmentRules.Domain.ValidationOutcome",
					"EnrolmentRules.Domain.ValidatedEvaluation`1", "EnrolmentRules.Domain.YamlConverter",
				}),
